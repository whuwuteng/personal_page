...
不过安装NVIDIA Drive会给安装CUDA带来问题，参考[blog](https://forums.developer.nvidia.com/t/nvdia-smi-show-cuda-version-but-nvcc-not-found/67311/3)， 因该意思是要重新安装CUDA的驱动，应为CUDA会带有NVIDIA的drive。

先卸载NVIDIA Drive，然后安装CUDA。
